...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mdi-text-to-image)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/mdi-text-to-image
```

A live public deployment of this template is available at [https://mdi-text-to-image.templates.workers.dev](https://mdi-text-to-image.templates.workers.dev)
